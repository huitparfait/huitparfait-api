...
test('GET /api/users/15c336ea-091b-425a-a99b-190179623ad4 (john Lennon)', async () => {
  const response = await server.get('/api/users/15c336ea-091b-425a-a99b-190179623ad4');
